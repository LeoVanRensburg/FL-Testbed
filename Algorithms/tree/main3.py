...
def main():
    ...
    nodeIPs = ["10.0.1.20", "10.0.4.20", "0.0.0.0", "10.0.2.21", "10.0.3.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    ...
    if(topology == 6):
        # FCG
        node3 = node.Node(nodeIPs[2], 9999, nodeValues[2], [nodeIPs[i] for i in [0,3,4]], algorithm, nrOfIterations)
