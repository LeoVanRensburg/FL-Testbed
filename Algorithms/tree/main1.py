...
def main():
    ...
    nodeIPs = ["0.0.0.0", "10.0.1.21", "10.0.0.21", "10.0.2.21", "10.0.3.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 100
    ...
    if(topology == 6):
        # FCG
        node1 = node.Node(nodeIPs[0], 9999, nodeValues[0], [nodeIPs[i] for i in [1,2]], algorithm, nrOfIterations)
