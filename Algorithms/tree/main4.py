...
def main():
    ...
    nodeIPs = ["10.0.2.20", "10.0.6.20", "10.0.2.20", "0.0.0.0", "10.0.8.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    ...
    if(topology == 6):
        # FCG
        node4 = node.Node(nodeIPs[3], 9999, nodeValues[3], [nodeIPs[i] for i in [2]], algorithm, nrOfIterations)
