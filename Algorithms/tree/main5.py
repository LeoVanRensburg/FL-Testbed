...
def main():
    ...
    nodeIPs = ["10.0.3.20", "10.0.5.20", "10.0.3.20", "10.0.8.20", "0.0.0.0", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    ...
    if(topology == 6):
        # FCG
        node5 = node.Node(nodeIPs[4], 9999, nodeValues[4], [nodeIPs[i] for i in [2]], algorithm, nrOfIterations)
