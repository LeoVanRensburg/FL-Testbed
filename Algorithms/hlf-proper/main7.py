...
def main():
    ...
    nodeIPs = ["10.0.18.20", "10.0.18.21", "10.0.7.20", "0.0.0.0", "10.0.8.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    ...
    if topology == 6:
        ...
        # Notify main13 that node 7 is ready
        notify_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        notify_socket.connect(("10.0.18.21", 12346))
        notify_socket.sendall(b"node7_ready")
        notify_socket.close()
