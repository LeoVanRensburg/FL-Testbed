...
def main():
    ...
    nodeIPs = ["10.0.20.20", "10.0.20.21", "10.0.7.20", "0.0.0.0", "10.0.8.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    ...
    if topology == 6:
        ...
        # Notify main13 that node 9 is ready
        notify_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        notify_socket.connect(("10.0.20.21", 12346))
        notify_socket.sendall(b"node9_ready")
        notify_socket.close()
