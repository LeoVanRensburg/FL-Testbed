...
def main():
    ...
    nodeIPs = ["10.0.13.20", "10.0.14.21", "0.0.0.0", "10.0.7.21", "10.0.9.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    reportingIP = "10.0.17.21"
    
    if(topology == 6):
        # FCG
        node3 = node.Node(nodeIPs[2], 9999, nodeValues[2], [nodeIPs[i] for i in [0,1]], algorithm, nrOfIterations, reportingIP)
