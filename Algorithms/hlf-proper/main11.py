...
def main():
    ...
    nodeIPs = ["10.0.16.21", "0.0.0.0", "10.0.14.20", "10.0.6.21", "10.0.5.21", "10.0.0.25", "10.0.0.26", "10.0.0.27"]
    algorithm = 1
    topology = 6
    nrOfIterations = 10
    reportingIP = "10.0.15.21"
    
    if(topology == 6):
        # FCG
        node2 = node.Node(nodeIPs[1], 9999, nodeValues[1], [nodeIPs[i] for i in [0,2]], algorithm, nrOfIterations, reportingIP)
