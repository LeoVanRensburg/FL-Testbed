    ...
    try:
        ...
        for link in session.links:
            ...
            link_info = {
                ...
                "delay": link.options.delay if hasattr(link, 'options') else None
            }
            links.append(link_info)

        sorted_links = sort_links(links)
        return json.dumps({"delay": sorted_links}, default=str)
...
if __name__ == "__main__":
    ...
    if session_id is not None:
        print(get_delay_info(session_id))
    else:
